...
public final class SystemParams {
	 ...
	 */
	public static double PERCEPT_LENGTH = WHOLE_NOTE_DURATION - 0.001;
	/**
	 ...
	 */
	public static double LAGGING_LENGTH = PERCEPT_LENGTH/4;
	
	/**
	 * Whether or not to show the Composition in a GUI.
	 * NOTE: GUI may not refresh in time if agent delay is not long enough.
	 */
	public static boolean SHOW_COMPOSITION_GUI = true;
	/**
	 * Whether or not to select user input.
	 */
	public static boolean ACCEPT_USER_INPUT = true;
	
	public static ViewType VIEW_TYPE = ViewType.MIDISCORE;
}
